...
<head>
  ...
  <script src="modifClasse.js" defer></script>
</head>
...
<body class="text-white bg-dark">
  ...
  <section class="container p-3 my-3 border border-primary">
    ...
    echo ("<h3 class='text-center'> Choix de la classe : </h3>");

    echo ('<div class="d-flex flex-column justify-content-center align-items-center">');

      echo ('<select class="col-md-4 form-control rounded-0 my-3" id="choixClasse">');
        echo ('<option selected> -- Choisir une classe -- </option>');
